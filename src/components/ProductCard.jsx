      ...
      <div className="flex-1 p-5 flex flex-col justify-between gap-4">
            ...
            {product.sizes.map((size) => (
              <button
                ...
                className={`px-3 py-1.5 rounded-lg text-xs font-bold transition-all ${
                  selectedSize === size
                    ? 'bg-amber-500 text-slate-950 shadow-md shadow-amber-500/25 border-amber-500'
        ...
        <div className="relative">
          ...
          {customImage ? (
            ...
            /* Empty Upload State */
            <label className={`flex flex-col items-center justify-center border-2 border-dashed rounded-xl cursor-pointer p-4 transition-all ${
              uploading 
                ? 'border-amber-500/30 bg-slate-950/50' 
              ...
              {uploading ? (
                ...
                <div className="flex flex-col items-center gap-1.5 text-center">
                  ...
                  <span className="text-xs font-medium text-gray-300">Choose photo to print</span>
        ...
        <div className="flex items-center gap-3 mt-2">
          ...
          <button
            ...
            disabled={isCustomizedCategory && !customImage}
